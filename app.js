...
const cafe1 = new Cafe ("Rambla", "Nicaragua", 1400, 1, "../Imagenes/CafeRambla.jpg");
const cafe2 = new Cafe ("Puerto Bles", "Kenia", 1400, 2, "../Imagenes/Kenia.jpeg");
const cafe3 = new Cafe ("Puerto Blest", "Colombia", 1200, 3, "../Imagenes/Colombia.jpeg");
const cafe4 = new Cafe ("Puerto Blest", "Guatemala", 1200, 4, "../Imagenes/Guatemala.jpeg");
const cafe5 = new Cafe ("Puerto Blest", "Peru", 1200, 5, "../Imagenes/Peru.jpeg");
const cafe6 = new Cafe ("Puerto Blest", "El Salvador", 1200, 6, "../Imagenes/ElSalvador.png");
